                ...
                <form method="GET" autocomplete="on">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="city" id="city" class="form-control" required>
                            ...
                            <option value="Bogor" <?php if (isset($city) && $city == "Bogor") echo 'selected' ?>>Bogor</option>
                            <option value="Ngawi" <?php if (isset($city) && $city == "Ngawi") echo 'selected' ?>>Ngawi</option>
                            <option value="Bekasi" <?php if (isset($city) && $city == "Bekasi") echo 'selected' ?>>Bekasi</option>
                        </select>
